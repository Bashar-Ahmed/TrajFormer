...
class TransformerEncoder(Module):
    ...
    def forward(
        ...
        """
        src_key_padding_mask = utils._canonical_mask(
            mask=src_key_padding_mask,
            mask_name="src_key_padding_mask",
            other_type=utils._none_or_dtype(mask),
            other_name="mask",
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model: int, nhead: int, dim_feedforward: int = 2048, dropout: float = 0.1,
        ...
        if activation is relu or isinstance(activation, torch.nn.ReLU):
    ...
    def forward(
        ...
        src_key_padding_mask = utils._canonical_mask(
            mask=src_key_padding_mask,
            mask_name="src_key_padding_mask",
            other_type=utils._none_or_dtype(src_mask),
            other_name="src_mask",
            target_type=src.dtype
        )
