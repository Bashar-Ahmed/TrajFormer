...
class SinkhornDual(nn.Module):
    ...
    """
    def __init__(self, eps=1 , max_iter=5, reduction='none', cost=cost_matrix):
        super(SinkhornDual, self).__init__()
        self.eps = eps
...
class SinkhornSingle(nn.Module):

    def __init__(self, eps, max_iter, reduction='none'):
        super(SinkhornSingle, self).__init__()
        self.eps = eps
        self.max_iter = max_iter
        self.reduction = reduction
